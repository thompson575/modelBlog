...
* `test.csv` the data used to evaluation performance  
...
The data from each *Sliced* episode is analysed in a different folder named after the episode, s01-e01, s01-e02 etc. So in the setup section of my code I deine the home directory, say,

home <- "C:/Projects/sliced/s01-e02"

Within the home folders I create subfolders called
...
I also have a standard subfolder structure with docs and archive subfolders with R and rmd, but for sliced I have not needed to use them. 

Although many of the subfolders do not get used for *Sliced*, this is the structure that I use for every data analysis and so I have continued to use it. I have a function that creates these folders and I run it at the start of every project.
