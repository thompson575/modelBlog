...
The intended response is profit after discounting, which I have truncated at -$250 and +$250 for this histogram.
```{r}
...
However we can work with the profit before discount, which I call baseProfit.
...
It looks like the store only sells office supplies but even so, these categories are quite broad; there must be several different types of table and many brands of phones. Let's look at the profit/sales plot across subcategory and for particular subcategories.
